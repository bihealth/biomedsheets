...
def test_donor_shortcuts(sheet_cancer):
    ...
    assert str(cancer_cases.donors[0].name) == '000001-EX_001'
    ...
    assert str(cancer_cases.donors[1].name) == '000008-EX_002'
...
def test_sample_pair_shortcuts(sheet_cancer):
    ...
    assert pair.donor.name == '000001-EX_001'
    # Tumor sample: test samples
    assert pair.tumor_sample.name == '000005-EX_001-T1'
    assert pair.tumor_sample.dna_test_sample.name == '000006-EX_001-T1-DNA1'
    assert pair.tumor_sample.dna_test_sample.assay_sample.name == '000007-EX_001-T1-DNA1-WES1'
    assert pair.tumor_sample.rna_test_sample is None
    # Normal sample: test samples
    assert pair.normal_sample.name == '000002-EX_001-N1'
    assert pair.normal_sample.dna_test_sample.name == '000003-EX_001-N1-DNA1'
    assert pair.normal_sample.dna_test_sample.assay_sample.name == '000004-EX_001-N1-DNA1-WES1'
...
def test_sample_pairs_all(sheet_cancer):
    ...
    assert cancer_cases.all_sample_pairs[0].donor.name == '000001-EX_001'
    assert cancer_cases.all_sample_pairs[0].tumor_sample.name == '000005-EX_001-T1'
    assert cancer_cases.all_sample_pairs[0].normal_sample.name == '000002-EX_001-N1'
    assert cancer_cases.all_sample_pairs[1].tumor_sample.name == '000012-EX_002-T1'
    assert cancer_cases.all_sample_pairs[1].normal_sample.name == '000009-EX_002-N1'
...
def test_sample_pairs_primary(sheet_cancer):
    ...
    assert cancer_cases.primary_sample_pairs[0].donor.name == '000001-EX_001'
    assert cancer_cases.primary_sample_pairs[0].tumor_sample.name == '000005-EX_001-T1'
    assert cancer_cases.primary_sample_pairs[0].normal_sample.name == '000002-EX_001-N1'
    assert cancer_cases.primary_sample_pairs[1].tumor_sample.name == '000012-EX_002-T1'
    assert cancer_cases.primary_sample_pairs[1].normal_sample.name == '000009-EX_002-N1'
